...
\begin{DoxyCompactItemize}
\item 
SFML\+\_\+\+SYSTEM\+\_\+\+API ANative\+Activity \texorpdfstring{$\ast$}{*} \mbox{\hyperlink{group__system_gabdf6d6135fca64627093a9906183c8e3}{sf\+::get\+Native\+Activity}} ()
\begin{DoxyCompactList}\small\item\em Return a pointer to the Android native activity. \end{DoxyCompactList}\item 
void SFML\+\_\+\+SYSTEM\+\_\+\+API \mbox{\hyperlink{group__system_ga2f2620831533dee0ed432ed982342e09}{sf\+::sleep}} (\mbox{\hyperlink{classsf_1_1_time}{Time}} duration)
\begin{DoxyCompactList}\small\item\em Make the current thread sleep for a given duration. \end{DoxyCompactList}\item 
SFML\+\_\+\+SYSTEM\+\_\+\+API std\+::ostream \& \mbox{\hyperlink{group__system_gad3cbfe676d6ca096c4a943bbd2ff3b83}{sf\+::err}} ()
...
SFML\+\_\+\+SYSTEM\+\_\+\+API std\+::ostream \& sf\+::err (\begin{DoxyParamCaption}{}{}\end{DoxyParamCaption})}



Standard stream used by SFML to output warnings and errors. 

By default, \doxylink{group__system_gad3cbfe676d6ca096c4a943bbd2ff3b83}{sf\+::err()} outputs to the same location as std\+::cerr, (-\/\texorpdfstring{$>$}{>} the stderr descriptor) which is the console if there\textquotesingle{}s one available.
...
\doxylink{group__system_gad3cbfe676d6ca096c4a943bbd2ff3b83}{sf\+::err()} can be redirected to write to another output, independently of std\+::cerr, by using the rdbuf() function provided by the std\+::ostream class.
...
\DoxyCodeLine{\mbox{\hyperlink{group__system_gad3cbfe676d6ca096c4a943bbd2ff3b83}{sf::err}}().rdbuf(NULL);}
\DoxyCodeLine{}
...
SFML\+\_\+\+SYSTEM\+\_\+\+API ANative\+Activity \texorpdfstring{$\ast$}{*} sf\+::get\+Native\+Activity (\begin{DoxyParamCaption}{}{}\end{DoxyParamCaption})}
...
\end{DoxyReturn}
\textbackslash{}sfplatform\{Android,\doxylink{_native_activity_8hpp_source}{SFML/\+System/\+Native\+Activity.\+hpp}\} \Hypertarget{group__system_ga2f2620831533dee0ed432ed982342e09}\index{System module@{System module}!sleep@{sleep}}
\index{sleep@{sleep}!System module@{System module}}
\doxysubsubsection{\texorpdfstring{sleep()}{sleep()}}
{\footnotesize\ttfamily \label{group__system_ga2f2620831533dee0ed432ed982342e09} 
void SFML\+\_\+\+SYSTEM\+\_\+\+API sf\+::sleep (\begin{DoxyParamCaption}\item[{\mbox{\hyperlink{classsf_1_1_time}{Time}}}]{duration}{}\end{DoxyParamCaption})}



Make the current thread sleep for a given duration. 

\doxylink{group__system_ga2f2620831533dee0ed432ed982342e09}{sf\+::sleep} is the best way to block a program or one of its threads, as it doesn\textquotesingle{}t consume any CPU power.
